...
//    public String sendMailWithInline(
//        @RequestParam(value = "recipientName", defaultValue ="antonio", required = false) final String recipientName,
//        @RequestParam(value = "recipientEmail", defaultValue = "antonio63j@gmail.com", required = false) final String recipientEmail,
//        @RequestParam(value = "body", defaultValue = "body", required = false) final String body,
//        final Locale locale)
//        throws MessagingException, IOException {
//
